function onUse(event) {
  ...
  let damageAttribute = org.bukkit.attribute.Attribute.GENERIC_MAX_HEALTH;
...
function addArmorAttribute(itemMeta, slot) {
  ...
  itemMeta.addAttributeModifier(org.bukkit.attribute.Attribute.GENERIC_MAX_HEALTH, newModifier);
}
...
function updateArmorAttribute(itemMeta, slot, amount) {
  ...
  itemMeta.removeAttributeModifier(org.bukkit.attribute.Attribute.GENERIC_MAX_HEALTH);
  itemMeta.addAttributeModifier(org.bukkit.attribute.Attribute.GENERIC_MAX_HEALTH, newModifier);
}
